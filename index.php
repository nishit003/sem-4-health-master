            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Health Master</h5>
                        <p class="animated bounceInDown">We provide best quality services to patient and our first and main responsibility is to take care about patient</p>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        ...
                        <p class="animated bounceInDown">Our main moto is first come first Serve....</p>
    ...
    <p><?php  echo $row['PageDescription'];?>.</p><?php } ?>
        ...
        <br/>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <p><a href="a.html"><img src="assets/images/gallery/gallery_01.jpg" class="img-responsive"></a></p>
                <p style="text-align:center;text-colour:black">Dentist</p>
                
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter sprinkle">
                <img src="assets/images/gallery/gallery_02.jpg" class="img-responsive">
                <p style="color:black;text-align:center">Cardiology</p>
            </div>


            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter irrigation">
                <img src="assets/images/gallery/gallery_04.jpg" class="img-responsive">
                <p style="color:black;text-align:center">laboratory</p>
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="assets/images/gallery/gallery_05.jpg" class="img-responsive">
                <p style="color:black;text-align:center">Neurology</p>
            </div>
